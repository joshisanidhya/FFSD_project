...
const REPORTS_DATA = [
    ...
    { id:'#4816', user:'GhostHacker',  av:'GH', bg:'linear-gradient(135deg,#34D399,#059669)', channel:'#devops',        reason:'⚠️ Other Rule Violation',       badge:'pending',   repeat:null,          time:'3h ago',  violations:1, days:60,  bans:0, warnings:0, sub:'Member since Jan 2026', unread:false },
